      ...
      if (data.count === 0) {
        ...
        for (let i = 0; i < data.jobs.length; i++) {
          ...
          let rowHTML = `
            ...
            <td>${data.jobs[i].workMode}</td>
            <td>${data.jobs[i].jobType}</td>
            <td>${data.jobs[i].location}</td>
            <td>${data.jobs[i].salaryRange.min} - ${
            data.jobs[i].salaryRange.max
          } ${data.jobs[i].salaryRange.currency}</td>
            <td>${data.jobs[i].appliedDate.split('T')[0]}</td>
